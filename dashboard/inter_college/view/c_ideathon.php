...
<div class="page-view-wrapper">
    ...
    <div class="action-bar">
        ...
        <a href="download_inter_college_participants.php?event=Ideathon " class="btn-download">&#8595; Download CSV</a>
    </div>
    ...
    <table class="data-table" id="participantTable">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='7' class='empty-state'>No participants found for Ideathon.</td></tr>";
            }
            ?>
        </tbody>
    </table>
