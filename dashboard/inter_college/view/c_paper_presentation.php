...
<div class="page-view-wrapper">
    ...
    <div class="action-bar">
        ...
        <a href="download_inter_college_participants.php?event=Paper+Presentation " class="btn-download">&#8595;
            Download CSV</a>
    </div>

    <div class="page-view-header">
        <h2>Paper Presentation &mdash; participants</h2>
    ...
    <table class="data-table" id="participantTable">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='7' class='empty-state'>No participants found for Paper Presentation.</td></tr>";
            }
            ?>
        </tbody>
    </table>
