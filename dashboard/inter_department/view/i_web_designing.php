<?php
include "header.php";
$sql = "SELECT `id`, `name`, `department`, `college`, `email`, `mobile`, `event1`, `event2`, `event1_attendance`, `event2_attendance` FROM `interdepartment` WHERE `event1` = 'Web Designing' OR `event2` = 'Web Designing'";
...
<div class="page-view-wrapper">
    ...
    <div class="action-bar">
        ...
        <a href="download_interdepartment_events.php?event=Web+Designing " class="btn-download">&#8595; Download CSV</a>
    </div>

    <div class="page-view-header">
        <h2>Web Designing &mdash; participants</h2>
    ...
    <table class="data-table" id="participantTable">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='8' class='empty-state'>No participants found for Web Designing.</td></tr>";
            }
            ?>
        </tbody>
    </table>
