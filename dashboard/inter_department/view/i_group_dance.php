<?php
include "header.php";
$sql = "SELECT `id`, `name`, `department`, `college`, `email`, `mobile`, `event1`, `event2`, `event1_attendance`, `event2_attendance` FROM `interdepartment` WHERE `event1` = 'Group Dance' OR `event2` = 'Group Dance'";
...
<div class="page-view-wrapper">
    ...
    <div class="action-bar">
        ...
        <a href="download_interdepartment_events.php?event=Group Dance" class="btn-download">&#8595; Download CSV</a>
    </div>
