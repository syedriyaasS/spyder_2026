...
if (isset($_GET['email']) && !empty(trim($_GET['email']))) {
    ...
    $sql = "SELECT * FROM interdepartment WHERE email = ?";
...
<div class="search-page-wrapper">
    ...
    <div class="search-card">
        ...
        <p class="subtitle">Find inter-department participant details using their registered email address</p>
    ...
    <?php if ($noResult): ?>
        <div class="no-result-box">&#9888; No participant found with email
