...
if (isset($_GET['mobile']) && !empty(trim($_GET['mobile']))) {
    ...
    $sql = "SELECT * FROM interdepartment WHERE mobile = ?";
...
<div class="search-page-wrapper">
    ...
    <div class="search-card">
        ...
        <p class="subtitle">Find inter-department participant details using their registered mobile number</p>
    ...
    <?php if ($noResult): ?>
        <div class="no-result-box">&#9888; No participant found with mobile number
