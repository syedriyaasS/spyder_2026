...
<div class="search-page-wrapper">
    ...
    <div class="search-card">
        ...
        <p class="subtitle">Find inter-college participant details using their registered email address</p>
    ...
    <?php if ($noResult): ?>
        <div class="no-result-box">
            &#9888; No participant found with email <strong><?php echo htmlspecialchars($_GET['email']); ?></strong>.
        </div>
